...
describe('ConsoleErrorFormatter:', function () {
    ...
    it('handles references', function () { var db = MMOM.parseSync('afile','$c x x $.'); expect(ConsoleErrorFormatter(Scoper.install(db).errors)).toBe('afile:1:6:error: A math symbol may not be redeclared as a constant\n|$c x »x« $.\nafile:1:4:info: Previous definition\n|$c »x« x $.\n'); });
});
