...
export class MMOMStatement {
    ...
    _unlazy() {
        ...
        scanner.statement._pos = { startPos: -1, mathPos: null, proofPos: null, spans: [] };
...
export class MMOMScanner {
    ...
    newSegment(lt_index) {
        ...
        if (!this.lazyPositions) this.statement._pos = { startPos: -1, mathPos: null, proofPos: null, spans: [] };
